...
MuseScore {
	version: "1.0"
	menuPath: "Accidentals.Second Viennese School.Remove Accidentals"
	description: "This plugin removes accidentals created by its sister plugin."
	requiresScore: true
	
	Component.onCompleted: {
		if (mscoreMajorVersion >= 4) {
			title = "Remove Second Viennese School Accidentals"
